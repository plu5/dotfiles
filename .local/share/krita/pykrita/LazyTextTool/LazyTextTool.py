...
class LazyTextTool(Extension):
    def __init__(self, parent):
        ...
        #self.bindToolButton()
        # ajouté par pm. mais c'est trop tôt pour ça
        # self.toggleTextTool()
        # alors essayons ça car cetait deja la dans un commentaire
        #self.bindToolButton()
        #meme probleme
        # autre tentative:
        notify = Krita.instance().notifier()
        notify.setActive(True)
        notify.viewCreated.connect(self.openViewEvent, 128)
    ...
    def bindLayerList2(self):
        ...
        if layerList and layerList.selectionModel():
    ...
    def unbindLayerList2(self):
        ...
        if layerList and layerList.model():
